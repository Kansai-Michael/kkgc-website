...
const nextConfig: NextConfig = {
  ...
  async headers() {
    return [
      {
        // Thank-you page must be embeddable by Kihon (app.kihonsoft.au) so the post-booking
        // redirect works inside their iframe — frame-ancestors overrides X-Frame-Options
        source: "/thank-you",
        headers: [
          {
